...
@interface FollowViewController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
...
- (NSAttributedString *)buttonTitleForEmptyDataSet:(UIScrollView *)scrollView forState:(UIControlState)state
{
    ...
    if(!isLogin){
        ...
        return [[NSAttributedString alloc] initWithString:@"点此立刻登录" attributes:attributes];
