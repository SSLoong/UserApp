...
@interface RetPwdViewController ()<UIGestureRecognizerDelegate>
...
@implementation RetPwdViewController
...
-(void)regAction{
    ...
    [AFHttpTool customerLoginpwdReset:_phoneField.text
...
-(void)codeAction:(UIButton *)button{
    ...
    _hud.labelText = @"正在发送...";
    _hud.userInteractionEnabled = NO;
    [AFHttpTool sendsmsFindpwd:_phoneField.text
                       progress:^(NSProgress *progress) {
...
-(void)setSubViews{
    ...
    [_regBtn setTitle:@"确 定" forState:UIControlStateNormal];
