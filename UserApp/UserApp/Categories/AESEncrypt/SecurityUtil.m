...
#define AES_KEY    @"SJKNBsjknbNBSJKN" //@"BNBNbbbbBNBNnnnn"
...
+ (NSString *)decryptAESHex:(NSString *)hexString
{
    NSData *data = [self dataFromHex:hexString];
    NSData *decryData = [data AES256DecryptWithKey:AES_KEY];
    NSString *dataString =  [[NSString alloc] initWithData:decryData  encoding:NSUTF8StringEncoding];
    return dataString;
}
